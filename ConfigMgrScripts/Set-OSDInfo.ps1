...
.NOTES
	...
	V1.1, 2016-5-6: Added, values for Date/Time, OS Image ID, UEFI, and Launch Mode
...
[cmdletBinding()]
Param(
        [Parameter(Mandatory=$false)][String]$WMI = "WMI",
        [Parameter(Mandatory=$false)][String]$Registry = "Registry",
        [Parameter(Mandatory=$false)][String]$Namespace = "JBL_IT",
...
$ID = $tsenv.value("_SMSTSPackageName")
$keyValue = "ID"
